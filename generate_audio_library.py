...
tracks = [
    ...
    ('twilight_horizon.wav', [
        ...
        [130.81, 164.81, 196.00, 233.08, 293.66],
        [98.00, 146.83, 174.61, 220.00, 261.63],
        [116.54, 174.61, 220.00, 261.63, 349.23]
    ], 'lofi', 48),
    ...
    ('solitude_reflection.wav', [
        [82.41, 123.47, 164.81, 196.00, 246.94],
        [73.42, 110.00, 146.83, 185.00, 220.00],
        [65.41, 98.00, 130.81, 164.81, 196.00],
        [73.42, 110.00, 146.83, 185.00, 220.00]
    ], 'piano', 40),

    ('midnight_starlight.wav', [
        [87.31, 130.81, 174.61, 220.00, 261.63, 349.23],
        [110.00, 164.81, 220.00, 261.63, 329.63],
        [98.00, 146.83, 196.00, 246.94, 293.66],
        [130.81, 196.00, 261.63, 329.63, 392.00]
    ], 'pad', 35)
