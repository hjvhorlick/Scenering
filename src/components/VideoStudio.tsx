...
export default function VideoStudio({
  ...
  return (
    <div className="flex flex-col bg-gray-950 text-white rounded-2xl border border-hairline overflow-hidden shadow-lg">
      ...
      <div className="bg-gray-900/60 border-b border-hairline px-4 py-2.5 flex items-center gap-2 overflow-x-auto no-scrollbar" role="tablist" aria-label="Video Studio sections">
        {STUDIO_CATEGORIES.map((cat, idx) => {
          ...
          return (
            <button
              ...
              className={`opt-btn shrink-0 ${cat.id === "intro" ? "opt-btn-amber" : cat.id === "outro" ? "opt-btn-rose" : ""} ${isSelected ? "opt-btn-on" : ""}`}
            >
      ...
      {!isCustomTab && currentCategoryDef?.subcategories && (
        <div className="bg-gray-950/70 px-5 py-2 border-b border-hairline flex flex-wrap items-center gap-2">
          ...
          {currentCategoryDef.subcategories.map((sub) => {
            ...
            return (
              <button
                ...
                className={`opt-btn ${isSubSelected ? "opt-btn-on" : ""}`}
              >
                <span>{sub.icon}</span>
                <span>{sub.name}</span>
              </button>
                    ...
                    >
                      ...
                      <div className="mt-4 pt-3 border-t border-hairline flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1.5 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white border border-hairline rounded-lg text-xs transition-colors"
