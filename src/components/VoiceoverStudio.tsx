  ...
  return (
    <div className="max-w-5xl 2xl:max-w-7xl mx-auto w-full space-y-3 sm:space-y-5 animate-fade-in p-1.5 sm:p-0">
      ...
      <div className="bg-gray-900/90 border border-indigo-900/60 rounded-2xl p-5 shadow-xl space-y-4">
              ...
              <button
                ...
                className={`p-2.5 rounded-xl border text-left transition-all ${
                  active
                    ...
                    : "bg-gray-800/50 border-hairline hover:bg-gray-800"
                }`}
              >
        ...
        {echoConfig.enabled && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 bg-gray-800/40 border border-hairline rounded-xl p-3">
            <div>
            ...
            <div className="sm:col-span-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-2 border-t border-hairline">
